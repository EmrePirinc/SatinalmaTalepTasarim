...
// Demo kullanıcılar (sadece UI için)
const mockUsers = [
  { username: "user1", password: "1234", name: "Selim Aksu", role: "user" },
  { username: "satinalma", password: "1234", name: "Satınalma Kullanıcısı", role: "purchaser" },
  { username: "admin", password: "1234", name: "Admin Kullanıcı", role: "admin" },
]
      ...
      if (response.success && response.user) {
        ...
        localStorage.setItem(
          ...
          JSON.stringify({
            ...
            sapId: response.user.sapId,
            purchaseAuthority: response.user.purchaseAuthority,
            financeAuthority: response.user.financeAuthority,
          })
        )
        ...
        if (response.user.role === "admin") {
          navigate("/admin")
        } else if (response.user.role === "purchaser") {
          ...
          <div className="mt-10 pt-6 border-t border-gray-200/50">
            ...
            <div className="space-y-2 text-xs text-gray-600">
              ...
              >
                ...
                <span className="text-gray-500 font-mono text-[10px] group-hover:text-gray-700 transition-colors">admin / 1234</span>
              </div>
            </div>
          </div>
        </div>

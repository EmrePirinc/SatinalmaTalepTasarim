...
const mockUsers = [
  { id: 1, username: "user1", password: "1234", name: "Selim Aksu", role: "user" },
  { id: 2, username: "satinalma", password: "1234", name: "Satınalma Kullanıcısı", role: "purchaser" },
  { id: 3, username: "admin", password: "admin123", name: "Admin Kullanıcı", role: "admin" },
]
...
export default function Login() {
  ...
  const handleLogin = async () => {
    try {
      ...
      // Sadece userId'yi localStorage'a kaydet (Yetki kontrolü API'den yapılacak)
      localStorage.setItem("userId", String(data.user.id))
      localStorage.setItem("userRole", data.user.role) // Routing için gerekli

      // Role göre yönlendirme
      if (data.user.role === "admin") {
        navigate("/admin")
      } else if (data.user.role === "purchaser") {
      ...
      setError("Sunucu ile bağlantı kurulamadı. Backend çalışıyor mu?")
    }
  }
          ...
          <div className="mt-10 pt-6 border-t border-gray-200/50">
            ...
            <div className="space-y-2 text-xs text-gray-600">
              ...
              >
                ...
                <span className="text-gray-500 font-mono text-[10px] group-hover:text-gray-700 transition-colors">user1 / 1234</span>
              </div>
              <div
              ...
              >
                ...
                <span className="text-gray-500 font-mono text-[10px] group-hover:text-gray-700 transition-colors">satinalma / 1234</span>
              </div>
              <div
              ...
              >
                ...
                <span className="text-gray-500 font-mono text-[10px] group-hover:text-gray-700 transition-colors">admin / admin123</span>
              </div>
            </div>
          </div>
        </div>
